...
import third_party.deit.models as models
import third_party.deit.models_v2 as model_v2
...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='mvit-tiny', type=str, metavar='MODEL',
    ...
    # Dataset parameters
    parser.add_argument('--data-path', default=env_vars.get_imagenet_root(), type=str,
                        help='dataset path')
    ...
    parser.add_argument('--output_dir', default='./saves/mvit-tiny-deit/',
