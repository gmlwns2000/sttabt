...
def load_points():
    ...
    ret = [
        ...
        (4.58, 79.8, 'DeiT-S'),
        (2.64, 79.34, 'SPViT-DeiT-S'),
        (3.15, 79.1, 'IA-RED$^2$'),
        (3.14, 79.22, 'S$^2$ ViTE'),
        (2.4, 78.00, 'HVT-S-1'),
        
        (3.25, 79.0, 'DeiT-S/320'),
        # (2.00, 78.65, 'SPViT-DeiT-S/320'),
        
        (2.65, 78.53, 'DeiT-S/288'),
        
        (2.14, 77.21, 'DeiT-S/256'),
...
def main():
    ...
    xs_other, ys_other, labels_other = load_points()
    ...
    plt.scatter(xs_other, ys_other, color=COLOR_MANUAL_TOPK)
